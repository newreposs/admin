...
class Config:
    ...
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002177313429"))
    KANAL = int(os.environ.get("KANAL", "-1002236557833"))
    ...
    AUTH_CHANNEL = int(os.environ.get("AUTH_CHANNEL", "-1002128590799"))
